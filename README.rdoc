...
OKFN Annotator is an inline annotation for the web in pure Javascript. You can found at https://github.com/okfn/annotator .

All requirement files are imported into 
